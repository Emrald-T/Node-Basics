...
switch (option) {
	...
	case 'count': const oranges = ['orange', 'orange']
	...
	// Stack trace
	case 'trace': function1 = () => console.trace()
				function2 = () => function1()
				function2()
				break

	// Measure time taken by function to run
	case 'timer': const doSomething = () => console.log('This is something');
				const measureTime = () => {
	...
	case 'progress': const bar = new ProgressBar("[:bar] :rate/bps :etas", {total: 10});
